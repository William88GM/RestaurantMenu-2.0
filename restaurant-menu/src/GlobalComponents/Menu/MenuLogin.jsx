        ...
        <>
            <div className={`MenuAdmin`}>
                ...
                <form onSubmit={handleSubmit}>
                    <input onChange={handleChange} value={formData.user} placeholder="Usuario" type="text" name="user" id="user" />
                    <div className="flex relative">
                        <input onChange={handleChange} value={formData.password} placeholder="Contraseña" type={showPassword ? "text" : "password"} name="password" id="password" />
                        {showPassword ?
                            <svg onClick={() => setShowPassword(!showPassword)} className="el-ojito cursor-pointer absolute right-2 top-[50%] translate-y-[-50%] mr-2" xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 24 24" fill="none">
                ...
                {loading ? <span className='loaderClarito mt-20'></span> : ""}
                {errorState ? <span className='text-white mt-6'>Contraseña o Usuario incorrectos</span> : ""}
            </div>
