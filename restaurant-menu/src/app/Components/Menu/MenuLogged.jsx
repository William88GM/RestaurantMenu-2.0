                ...
                {!loading && formData ?
                    <form onSubmit={handleSubmit} className="my-8" >
                        ...
                        <div className="flex relative">
                            ...
                            {showPassword ?
                                <svg onClick={() => setShowPassword(!showPassword)} className="cursor-pointer absolute right-2 top-[50%] translate-y-[-50%] mr-2" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24" fill="none">
                        ...
                        <div className='flex flex-col my-6 bg-red-300 rounded-3xl p-4'>
                            <h5>     Visualizar productos en modo lista</h5>
