...
export default function NormalMode2({ handleDetails, viewerMode, p, details, baseURL, galleryRef, ediciones, }) {
                ...
                {!ediciones[0] ?
                    ...
                    <div ref={galleryRef} style={{ scrollBehavior: "smooth" }} className={viewerMode ? "galery galery-small" : "galery"}>
                        ...
                        {ediciones[0] && ediciones.map((e, i) => {
                            return <ListItems2 e={e} key={e.id} viewerMode={viewerMode} handleDetails={handleDetails} />
                        })}
