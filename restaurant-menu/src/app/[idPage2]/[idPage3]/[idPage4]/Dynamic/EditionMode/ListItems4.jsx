...
export default function ListItems4({ imagesHaveChanged, viewerMode, data, handleVisionItem, e, logged, toEliminate, handleBannerEliminate, dragActive, i, ediciones, setEdiciones }) {
    ...
    return (dragActive ? (
        ...
        : (
            <div key={e.id} id={e.id} className={viewerMode ? "galery-item-small-user" : 'galery-item '} ref={setNodeRef}>
                ...
                {logged ? !toEliminate ? <button className='buttonDelete' id={e.id} onClick={handleBannerEliminate}>❌</button> : "" : ""}
